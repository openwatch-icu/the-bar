// Test 0 — Baseline / sanity: connect, join room, send 1 E2E msg every 10s, stay 5 min.
      ...
      (async function sendLoop() {
        ...
        for (let i = 0; i < numMsgs; i++) {
          ...
          try {
            ...
            const payload = await encryptMessage(key, 'hello-' + __VU + '-' + __ITER + '-' + i);
            socket.send(payload + NL);
          } catch (_) {
            // skip message on crypto error
          }
        }
      })();
    });
